...
reserves_ode <- function(t, V,par) {
  ...
  dV1 <- par$b1_t[tt]-par$mu[tt]*V[1] +r(t)*V[1] - dV1_s
  dV2 <- par$b2_t[tt]-par$mu[tt]*V[2] +r(t)*V[2] - dV2_s
...
# save plot
ggsave("Plots/granularity.jpg", width = 10, height = 10, units = "cm")
```
...
# save plot
ggsave("Plots/premiums_V1_V2_2.jpg", width = 10, height = 10, units = "cm")
...
# save plot
ggsave("Plots/premiums.jpg", width = 10, height = 10, units = "cm")
...
p
# save plot
ggsave("Plots/reserve_bootstraps.jpg", width = 10, height = 10, units = "cm")
...
ggsave("Plots/bootstrap_one_time_premiums.jpg", width = 10, height = 10, units = "cm")
